...
public class StartPanel extends JPanel {
	...
	public StartPanel() {
		// Bild aus src/resources laden
		java.net.URL logoURL = getClass().getResource("/Logo.PNG");

		if (logoURL != null) {
			logo = new ImageIcon(logoURL);
		} else {
			System.err.println("Bild konnte nicht geladen werden: /resources/Logo.PNG");
			return; // Abbrechen, wenn die Ressource nicht gefunden wurde
		}
